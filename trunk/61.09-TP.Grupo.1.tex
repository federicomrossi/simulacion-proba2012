...
% Código
\lstinputlisting[label=code:punto7,caption=probDeLaLongitud.m]{source/probDeLaLongitud.m}
\bigskip
...
Esta función (\refcode{code:punto9}) grafica los valores de la longitud de la secuencias que hay en la 'listaDeSecuencias'. Además grafica la esperanza de la longitud.\bigskip\\

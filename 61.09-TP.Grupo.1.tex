...
\section{Introducción}
	...
	Con el fin de fortalecer las nociones fundamentales de la probabilidad es que este trabajo tiene como objetivo el aplicar las bases de los conceptos ya estudiados en el curso de manera tal de permitirnos una mejor comprensión de la inferencia estadística en hechos cotidianos. En este caso, nuestro trabajo será explorar las propiedades estádisticas de cierto tipo de secuencias, las cuales serán detalladas más adelante.
	\par 
